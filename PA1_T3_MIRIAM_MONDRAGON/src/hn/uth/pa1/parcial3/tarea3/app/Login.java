...
public class Login extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        try {
            usuarios = usuariosController.buscarTodosActivos();
        } catch (Exception ex) {
        ...
        for (Usuarios usuarioTmp : usuarios) {
            if (usuarioTmp.getUsuario().equals(usuario) && usuarioTmp.getContrasenia().equals(clave)) {
                usuarioFinal = usuarioTmp;
            }
        }
        if(usuarioFinal != null){
            if(usuarioFinal.getUsuario().equals("ADMINISTRADOR")){
                FrmUsuarios usuariosFrm = new FrmUsuarios();
                util.mostrarFormulario(usuariosFrm);
            }else{
                FrmPacientes usuariosFrm = new FrmPacientes();
                util.mostrarFormulario(usuariosFrm);
            }
        }else{
            JOptionPane.showMessageDialog(this, "Usuario no registrado, inactivo o credenciales mal ingresadas", "Credenciales Inválidas", JOptionPane.ERROR_MESSAGE);
        }
